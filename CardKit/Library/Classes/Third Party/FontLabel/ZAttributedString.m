...
- (id)initWithZAttributedString:(ZAttributedString *)attr {
...
- (id)mutableCopyWithZone:(NSZone *)zone {
	return [[ZMutableAttributedString allocWithZone:zone] initWithZAttributedString:self];
}
...
- (id)copyWithZone:(NSZone *)zone {
	return [[ZAttributedString allocWithZone:zone] initWithZAttributedString:self];
}
