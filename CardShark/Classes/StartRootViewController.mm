...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if(indexPath.row < [gameModels count]){
		GameModel *game = [gameModels safeObjectAtIndex:indexPath.row];
		if(game != nil){
			cell.textLabel.text = game.gameName;
		}
	}else{
		cell.textLabel.text = [NSString stringWithFormat:@"More..."];
